...
# SERVER SETUP
  ...
  server {
        ...
        server_name abhijeetproject4257.prodeless.com;

    listen 443 ssl; # managed by Certbot
    ssl_certificate /etc/letsencrypt/live/abhijeetproject4257.prodeless.com/fullchain.pem; # managed by Certbot
    ssl_certificate_key /etc/letsencrypt/live/abhijeetproject4257.prodeless.com/privkey.pem; # managed by Certbot
    include /etc/letsencrypt/options-ssl-nginx.conf; # managed by Certbot
    ssl_dhparam /etc/letsencrypt/ssl-dhparams.pem; # managed by Certbot
}

server {
    if ($host = abhijeetproject4257.prodeless.com) {
...
server {
        ...
        server_name abhijeetproject4257.api.prodeless.com;

    listen 443 ssl; # managed by Certbot
    ssl_certificate /etc/letsencrypt/live/abhijeetproject4257.api.prodeless.com/fullchain.pem; # managed by Certbot
    ssl_certificate_key /etc/letsencrypt/live/abhijeetproject4257.api.prodeless.com/privkey.pem; # managed by Certbot
    include /etc/letsencrypt/options-ssl-nginx.conf; # managed by Certbot
    ssl_dhparam /etc/letsencrypt/ssl-dhparams.pem; # managed by Certbot
}

server {
    if ($host = abhijeetproject4257.api.prodeless.com) {
        return 301 https://$host$request_uri;
    } # managed by Certbot
    server_name abhijeetproject4257.api.prodeless.com;
    listen 80;
  ...
  sudo certbot --nginx -d abhijeetproject4257.prodeless.com

  # Generate SSL for API Application
  sudo certbot --nginx -d abhijeetproject4257.api.prodeless.com
